...
<body>
  ...
  <header id="header" class="page-topbar">
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color" style='background-color:#1976d2'>
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">SH Co.</a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                ...
                <div class="col col s8 m8 l8">
                    <a class="btn-flat dropdown-button waves-light white-text profile-btn" href="#" data-activates="profile-dropdown"><?php echo $name;?> <i class="mdi-navigation-arrow-drop-down right"></i></a>
                    <p class="user-roal"><?php echo $role;?></p>
                </div>
            </div>
            </li>
            <li class="bold active"><a href="admin-page.php" class="waves-effect"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect"><i class="mdi-editor-insert-invitation"></i> Orders</a>
            ...
            <li class="bold"><a href="users.php" class="waves-effect"><i class="mdi-social-person"></i> Users</a>
            </li>				
        </ul>
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
            <div class="row">
			  ...
			  <div class="input-field col s12">
                              <button class="btn waves-effect waves-light right" style='background:#1976d2' type="submit" name="action">Modify
...
<table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn waves-effect waves-light right" type="submit" style="background:#1976d2" name="action">Add
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
            </div>
