        ...
        <div class="navbar-fixed">
            <nav class="navbar-color" style="background-color: #1976d2">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="admin-page.php" class="brand-logo darken-1">SH Co.</a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
...
<table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" style="background-color:#1976d2" type="submit" name="action">Modify
