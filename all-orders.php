        ...
        <div class="navbar-fixed">
            <nav class="navbar-color" style="background-color:#1976d2">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="admin-page.php" class="brand-logo darken-1">SH Co.</a></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="admin-page.php" class="waves-effect"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            ...
                            <span>SDG. '.$row1['price'].'</span>
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>SDG. '.$row['total'].'</strong></span>
                                            </div>';										
								if(!$deleted){
								echo '<button class="btn waves-effect waves-light right submit" style="background:#1976d2" type="submit" name="action">Change Status
